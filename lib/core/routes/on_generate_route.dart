...
import 'package:grocery/views/drawer/edit_product.dart';
import 'package:grocery/views/drawer/list_product.dart';
...
import '../../views/drawer/admin_page.dart';
...
class RouteGenerator {
  static Route? onGenerate(RouteSettings settings) {
    ...
    switch (route) {
      ...
      return CupertinoPageRoute(builder: (_) => const EditProductPage());

      case AppRoutes.listproduct:
        return CupertinoPageRoute(builder: (_) => const ListProduct());
